...
import { api, env } from '../../../data_supabase';
        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
            ...
            <header className="bg-white dark:bg-gray-800 shadow-md">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Panel de estudiante {env === "DES" && "(DESARROLLO)"}</h1>
                    <div>
            ...
            {infoModalContent && (
                <Modal onClose={() => setInfoModalContent(null)} title={infoModalContent.title}>
                    ...
                    <div className="flex justify-end mt-6">
                        <Button onClick={() => setInfoModalContent(null)}>Cerrar</Button>
                    </div>
                </Modal>
            )}
